                ...
                <div className="w-full p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-around items-start">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                            ...
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-black">Get Involved</h2>
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="/volunteer" className="hover:underline">Volunteer with us</a>
                                    </li>
                                    <li className="mb-4">
                                        <a href="/research" className="hover:underline">Join Research</a>
                                    </li>
                                    <li>
                            ...
                            <div>
                                ...
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="https://www.instagram.com/legalsrot?igsh=MWU3ZDlremJ4ZWw0aQ%3D%3D&utm_source=qr" className="hover:underline flex items-center gap-2">
                                    ...
                                    <li className="mb-4">
                                        <a href="https://www.facebook.com/profile.php?id=61565081227673&mibextid=LQQJ4d" className="hover:underline flex items-center gap-2">
                                            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                    ...
                                    {/* linkedin as well */}
                                    <li className="mb-4">
                                        <a href="https://www.linkedin.com/company/legalsrot/" className="hover:underline flex items-center gap-2">
                    ...
                    <div className="sm:flex sm:items-center justify-around">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://legalshrot.com.np" className="hover:underline">Legal Shrot</a>. All Rights Reserved.
                        </span>
                        <div className="flex gap-2 mt-4 sm:justify-center sm:mt-0">
                            <a href="https://www.facebook.com/profile.php?id=61565081227673&mibextid=LQQJ4d" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                <span className="sr-only">Facebook</span>
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/legalsrot?igsh=MWU3ZDlremJ4ZWw0aQ%3D%3D&utm_source=qr" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="https://www.linkedin.com/company/legalsrot/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.5 8C7.32843 8 8 7.32843 8 6.5C8 5.67157 7.32843 5 6.5 5C5.67157 5 5 5.67157 5 6.5C5 7.32843 5.67157 8 6.5 8Z" fill="currentColor" />
                                    <path d="M5 10C5 9.44772 5.44772 9 6 9H7C7.55228 9 8 9.44771 8 10V18C8 18.5523 7.55228 19 7 19H6C5.44772 19 5 18.5523 5 18V10Z" fill="currentColor" />
                                    <path d="M11 19H12C12.5523 19 13 18.5523 13 18V13.5C13 12 16 11 16 13V18.0004C16 18.5527 16.4477 19 17 19H18C18.5523 19 19 18.5523 19 18V12C19 10 17.5 9 15.5 9C13.5 9 13 10.5 13 10.5V10C13 9.44771 12.5523 9 12 9H11C10.4477 9 10 9.44772 10 10V18C10 18.5523 10.4477 19 11 19Z" fill="currentColor" />
